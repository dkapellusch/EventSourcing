...
namespace EventSourcing.TimerService
{
    internal class Program
    {
        ...
        private static IWebHostBuilder CreateHostBuilder(string[] args) => WebHost.CreateDefaultBuilder(args)
            .ConfigureKestrel(options => options.ListenAnyIP(4000, o => o.Protocols = HttpProtocols.Http2))
            .ConfigureServices((hostContext, services) => services
                .AddSingleton<TimerService>()
                .AddKafkaProducer<string, Tick>(new ProducerConfig
                {
            ...
            .Configure(builder => builder
                .UseRouting()
                .UseEndpoints(endpointBuilder => endpointBuilder.MapGrpcService<TimerService>())
            );
    }
}